...
class Thai_Emerald : public Restaurant {
    public:
    void thai_em_menu();
...
//Shows main menu
void Thai_Emerald::thai_em_menu()
{
    std::ifstream thai_em ("Menus/Thai Emerald/thai_em_menu.txt");
    ...
    if(thai_em.is_open()) {
        ...
        while( std::getline(thai_em, line))
        {
...
void Thai_Emerald::select_menu(std::vector<std::string> main_menu, int lines)
{
    if(lines>0) {
            int choice;
            std::cout << std::endl;
...
std::string Thai_Emerald::find_path(std::string selected)
{
    std::string path = "Menus/Thai Emerald/";
    std::string ext = ".txt";
...
void Thai_Emerald::show_sub_menu(std::string path)
{
...
void Thai_Emerald::select_item(std::vector<std::string> sub_menu, std::vector<std::string> items, int cost, int price)
{
            int choice;
...
void Thai_Emerald::space(std::vector<std::string> str)
{
...
void Thai_Emerald::process_options(int choice, std::vector<std::string> items, int price)
{
    if(choice == 1) {
...
void Thai_Emerald::select_menu_again(std::vector<std::string> main_menu, std::vector<std::string> items, int lines, int price)
{
    if(lines>0) {
            int choice;
            std::cout << std::endl;
...
void Thai_Emerald::show_sub_menu_again(std::string path, std::vector<std::string> items, int price)
{
        std::ifstream sub_menu_file (path);
