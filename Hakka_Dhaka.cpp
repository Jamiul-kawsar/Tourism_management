...
class Hakka_Dhaka : public Restaurant {
    public:
    //shows Hakka Dhaka menu
    void hakka_dhaka_menu();
...
//Shows main menu
void Hakka_Dhaka::hakka_dhaka_menu()
{
    std::ifstream hakka_dhaka ("Menus/Hakka Dhaka - Tejgaon/hakka_dhaka_tejgaon_menu.txt");

    if(hakka_dhaka.is_open()) {
        ...
        while( std::getline(hakka_dhaka, line))
        {
...
void Hakka_Dhaka::select_menu(std::vector<std::string> main_menu, int lines)
{
    if(lines>0) {
            int choice;
            std::cout << std::endl;
...
std::string Hakka_Dhaka::find_path(std::string selected)
{
    std::string path = "Menus/Hakka Dhaka - Tejgaon/";
    std::string ext = ".txt";
...
void Hakka_Dhaka::show_sub_menu(std::string path)
{
...
void Hakka_Dhaka::select_item(std::vector<std::string> sub_menu, std::vector<std::string> items, int cost, int price)
{
            int choice;
...
void Hakka_Dhaka::space(std::vector<std::string> str)
{
...
void Hakka_Dhaka::process_options(int choice, std::vector<std::string> items, int price)
{
    if(choice == 1) {
        checkout(items, price);
    } else {
        std::ifstream hakka ("Menus/Hakka Dhaka - Tejgaon/hakka_dhaka_tejgaon_menu.txt");
...
void Hakka_Dhaka::select_menu_again(std::vector<std::string> main_menu, std::vector<std::string> items, int lines, int price)
{
    if(lines>0) {
            int choice;
            std::cout << std::endl;
...
void Hakka_Dhaka::show_sub_menu_again(std::string path, std::vector<std::string> items, int price)
{
        std::ifstream sub_menu_file (path);
