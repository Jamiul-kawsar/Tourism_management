...
class Takeout_Tejgaon : public Restaurant {
    public:
    //shows main menu
    void takeout_tejgaon_menu();
...
//Shows main menu
void Takeout_Tejgaon::takeout_tejgaon_menu()
{
    std::ifstream takeout ("Menus/Takeout - Tejgaon/takeout_tejgaon_menu.txt");
    ...
    if(takeout.is_open()) {
        ...
        while( std::getline(takeout, line))
        {
...
void Takeout_Tejgaon::select_menu(std::vector<std::string> main_menu, int lines)
{
    if(lines>0) {
            int choice;
            std::cout << std::endl;
...
std::string Takeout_Tejgaon::find_path(std::string selected)
{
    std::string path = "Menus/Takeout - Tejgaon/";
    std::string ext = ".txt";
...
void Takeout_Tejgaon::show_sub_menu(std::string path)
{
...
void Takeout_Tejgaon::select_item(std::vector<std::string> sub_menu, std::vector<std::string> items, int cost, int price)
{
            int choice;
...
void Takeout_Tejgaon::space(std::vector<std::string> str)
{
...
void Takeout_Tejgaon::process_options(int choice, std::vector<std::string> items, int price)
{
    if(choice == 1) {
...
void Takeout_Tejgaon::select_menu_again(std::vector<std::string> main_menu, std::vector<std::string> items, int lines, int price)
{
    if(lines>0) {
            int choice;
            std::cout << std::endl;
...
void Takeout_Tejgaon::show_sub_menu_again(std::string path, std::vector<std::string> items, int price)
{
        std::ifstream sub_menu_file (path);
